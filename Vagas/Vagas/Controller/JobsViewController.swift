...
class JobsViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        adicionadosLabel.textColor = UIColor(hexString: "#1F213C")
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if collectionView == closerJobsCollection{
            ...
            if (indexPath.row == 0){
                myCell.empresaLabel.text = "Pucpr"
            }
            if (indexPath.row == 1){
                myCell.empresaLabel.text = "UTFPR"
            }
            else{
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        if (collectionView == closerJobsCollection){
            ...
            return CGSize(width: view.frame.size.width * 0.9, height: 90)
        }
    ...
    func setupCloserCell(cell: CloserJobsCollectionViewCell){
        ...
        cell.secondCardView.layer.shadowOpacity = 0.2
        ...
        cell.thirdCardView.layer.shadowOpacity = 0.2
